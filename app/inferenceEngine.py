...
This version:
- Fixes indentation/import errors
- Validates sensor data and feature ordering
- Supports both single-label and multi-label model outputs
- Writes CSV log with matching header/rows
